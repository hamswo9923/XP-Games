...
XP-Games is a collection of simple, lightweight games designed to run smoothly on older Windows systems. These games work on Windows XP and use minimal hardware resources. You do not need a modern computer or advanced software to enjoy them.
...
1. Look for the latest release version (usually the top one).
2. Under "Assets," find the `.zip` file or `.exe` installer if available.
...
### Option 1: Using the Installer (if available)

1. After downloading the `.exe` installer, locate it in your "Downloads" folder.
2. Double-click the file to start the installation wizard.
3. Follow the instructions on the screen. Usually, clicking "Next" will move you through the steps.
4. Choose where to install the program. The default folder is fine for most users.
5. When the installation finishes, you should see a shortcut on your Desktop or Start menu.
6. Double-click the shortcut to start XP-Games.

### Option 2: Using the ZIP File

1. If you downloaded a ZIP file, locate it in your "Downloads" folder.
2. Right-click the file and choose "Extract All..." or use a program like WinRAR or 7-Zip.
3. Select where to extract the files. The Desktop is a good place to find it easily.
4. Open the extracted folder.
5. Look for a file named `XP-Games.exe` or something similar.
6. Double-click this file to run the games launcher.
...
- **Program won’t start:** Make sure you downloaded the correct file and extracted it fully. Run the `.exe` file as administrator by right-clicking and selecting "Run as administrator."
- **Games run slowly:** Close other programs to free memory. Adjust your display resolution to a lower setting if possible.
